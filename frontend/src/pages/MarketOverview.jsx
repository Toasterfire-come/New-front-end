    ...
    <div className="container mx-auto px-6 py-8 space-y-8">
      ...
      <Card className="border-slate-200">
        <CardHeader>
          ...
          <CardDescription>Global market performance overview</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="font-semibold text-slate-800 mb-4">Asian Markets</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Nikkei 225</span>
                  <span className="text-sm font-medium text-emerald-600">+0.45%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Hang Seng</span>
                  <span className="text-sm font-medium text-red-600">-0.23%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Shanghai</span>
                  <span className="text-sm font-medium text-emerald-600">+0.12%</span>
                </div>
              </div>
            </div>
            
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="font-semibold text-slate-800 mb-4">European Markets</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">FTSE 100</span>
                  <span className="text-sm font-medium text-red-600">-0.15%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">DAX</span>
                  <span className="text-sm font-medium text-emerald-600">+0.28%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">CAC 40</span>
                  <span className="text-sm font-medium text-slate-600">+0.03%</span>
                </div>
              </div>
            </div>
            
            <div className="bg-slate-50 p-6 rounded-lg">
              <h3 className="font-semibold text-slate-800 mb-4">Commodities</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Crude Oil</span>
                  <span className="text-sm font-medium text-emerald-600">+1.25%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-600">Silver</span>
                  <span className="text-sm font-medium text-red-600">-0.67%</span>
                </div>
              </div>
            </div>
          </div>
